...
- [x] Expand Listings to include search, filters, infinite scrolling, detail sheets, AI-assisted creation/editing, mass list, and cover management via shared-core helpers and upload services.
  ...
  - [x] Wire full AI-assisted creation/editing flows.
  - [x] Implement mass listing workflows and cover image management.
