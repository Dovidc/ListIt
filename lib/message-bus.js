...
const TOPICS = {
  ...
  EBAY_DISCONNECTED: 'ebay.disconnected',
  EBAY_TOKEN_REFRESHED: 'ebay.token_refreshed',
  EBAY_TOKEN_EXPIRED: 'ebay.token_expired',
  EBAY_LISTING_CREATED: 'ebay.listing_created',
  EBAY_LISTING_PUBLISHED: 'ebay.listing_published',
  EBAY_LISTING_ENDED: 'ebay.listing_ended',
  EBAY_LISTING_SOLD: 'ebay.listing_sold',
  EBAY_LISTING_SYNC: 'ebay.listing_sync',
  EBAY_LISTING_ERROR: 'ebay.listing_error',
  EBAY_WEBHOOK: 'ebay.webhook'
};
